...
void assign_direction_moves(struct State *state, struct Coordinates **possible_moves, enum Direction direction, short x,
                            short y, enum Side chessman_side, short *current_index) {
...
struct Coordinates **
get_directions_possible_moves(struct State *state, enum Direction *directions, short number_of_directions, short x,
                              short y) {
...
struct Coordinates **get_knight_possible_moves(struct State *pState, short x, short y);
...
//            return get_pawn_possible_moves(board, x, y);
        case KNIGHT:
            return get_knight_possible_moves(state, x, y);
        case CASTLE:
...
struct Coordinates **get_knight_possible_moves(struct State *state, short x, short y) {
